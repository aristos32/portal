                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link-mine href="/" :active="request()->is('/')">Home</x-nav-link-mine>
                                <x-nav-link-mine href="/about" :active="request()->is('about')">About</x-nav-link-mine>
                                <x-nav-link-mine href="/contact"
                                    :active="request()->is('contact')">Contact</x-nav-link-mine>
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="text-sm font-medium leading-none text-gray-400">aristos@example.com</div>
                        </div>
                        <button type="button"
